...
if(file_exists('../private-config-bd.php'))  // fichier de configuration "privé" (enseignants)
	...
	define('UTILISATRICE', 'p2110686'); // votre login, par exemple p1234567
	define('MOTDEPASSE', 'Revolt90Silly'); // votre mot de passe, par exemple Abcd12Efgh
	define('BDD', 'p2110686'); // votre BD, par exemple p1234567	
}
?>
